...
export default function Header() {
    ...
    return (
        <header className="flex flex-col">
            <div className="flex flex-row bg-day-00 w-screen h-[56px] p-4 justify-between items-center border-b border-[#e6e6e6] pr-8">
                ...
                <div className='flex flex-row items-center space-x-1'>
                    ...
                    <button className='relative group text-day-350 hover:bg-day-50 flex items-center hover:border-b-2 hover:border-orange-100 duration-100 h-[56px] px-3'>
                        <p className='pr-1'>Help</p>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className='w-5 h-5 duration-300 group-hover:rotate-180'>
                            <path fillRule="evenodd" d="M5.23 7.21a.75.75 0 011.06.02L10 11.168l3.71-3.938a.75.75 0 111.08 1.04l-4.25 4.5a.75.75 0 01-1.08 0l-4.25-4.5a.75.75 0 01.02-1.06z" clipRule="evenodd" />
                        </svg>
                        <div className='hidden group-hover:flex flex-col py-2 bg-white rounded-lg shadow absolute right-0 top-[56px] border border-day-200 w-44 text-base z-20'>
                    ...
                    <button className='relative group text-day-350 hover:bg-day-50 flex items-center hover:border-b-2 hover:border-orange-100 duration-100 h-[56px] px-3'>
                        ...
                        <div className='hidden group-hover:flex flex-col py-2 bg-white rounded-lg shadow absolute top-[56px] border border-day-200 right-0 w-44 text-base z-20'>
                            <Link href="/dashboard"
                                className='text-day-350 hover:bg-day-100 p-1.5 mx-2 rounded-md text-left pl-3'>
                                Dashboard
                            </Link>
